...
async function energyRestoration(db) {
	const { User } = db;
	try {
...
const startEnergyRestoration = (db) => {
	setInterval(() => energyRestoration(db), SECONDS_INTERVAL * 1000);
};

module.exports = startEnergyRestoration;
