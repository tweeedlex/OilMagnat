...
const Header = ({isVisible = true}) => {
  ...
  return (
    <div className={[styles.info].join(" ")} style={{display: (isVisible ? "flex" : "none"), background: `url(${leftBg}) no-repeat 0 0 / contain`}}>
      ...
      <div className={[styles.infoSide, styles.right].join(" ")} style={{background: `url(${rightBg}) no-repeat 100% 0 / contain`}}>
