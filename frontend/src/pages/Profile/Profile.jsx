					...
					<div className={styles.profile}>
						<div className={styles.head}>
							<div className={styles.headBlock}>
								<img src={import.meta.env.VITE_API_URL + "/avatars/" + info.user.avatarUrl} alt={""} />
						...
						<div className={styles.table}>
							...
							<div className={styles.tableRow}>
								...
								<p className={styles.gold}>
									{info?.workers?.workersCount}/{info?.workers?.generalWorkerCount}
								</p>
							</div>
							<div className={styles.tableRow}>
								<p>Total Resources</p>
								<p className={styles.gold}>{info.totalResouces} BBL</p>
							</div>
							<div className={styles.tableRow}>
								<p>Tasks Сompleted</p>
